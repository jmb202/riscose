...
#define SHPREDOWNWB()                                   \
  ARMword temp = LHS - GetLS7RHS(state, instr) ;        \
	    ...
	    case 0x08:		/* ADD reg */
              ...
              if (BITS(4, 7) == 0x9)
                { /* MULL */
                  /* 32x32 = 64 */
                  ARMul_Icycles(state,
                      Multiply64(state, instr, LUNSIGNED, LDEFAULT), 0L) ;
                  break ;
                }
	    ...
	    case 0x09:		/* ADDS reg */
              ...
              if (BITS(4, 7) == 0x9)
                { /* MULL */
                  /* 32x32=64 */
                  ARMul_Icycles(state,
                      Multiply64(state, instr, LUNSIGNED, LSCC), 0L) ;
                  break ;
                }
	    ...
	    case 0x0a:		/* ADC reg */
              ...
              if (BITS(4, 7) == 0x9)
                { /* MULL */
                  /* 32x32=64 */
                  ARMul_Icycles(state,
                      MultiplyAdd64(state, instr, LUNSIGNED, LDEFAULT), 0L) ;
                  break ;
                }
	    ...
	    case 0x0b:		/* ADCS reg */
              ...
              if (BITS(4, 7) == 0x9)
                { /* MULL */
                  /* 32x32=64 */
                  ARMul_Icycles(state,
                      MultiplyAdd64(state, instr, LUNSIGNED, LSCC), 0L) ;
                  break ;
                }
	    ...
	    case 0x0c:		/* SBC reg */
              ...
              if (BITS(4, 7) == 0x9)
                { /* MULL */
                  /* 32x32=64 */
                  ARMul_Icycles(state,
                      Multiply64(state, instr, LSIGNED, LDEFAULT), 0L) ;
                  break ;
                }
	    ...
	    case 0x0d:		/* SBCS reg */
              ...
              if (BITS(4, 7) == 0x9)
                { /* MULL */
                  /* 32x32=64 */
                  ARMul_Icycles(state,
                      Multiply64(state, instr, LSIGNED, LSCC), 0L) ;
                  break ;
                }
	    ...
	    case 0x0e:		/* RSC reg */
              ...
              if (BITS(4, 7) == 0x9)
                { /* MULL */
                  /* 32x32=64 */
                  ARMul_Icycles(state,
                      MultiplyAdd64(state, instr, LSIGNED, LDEFAULT), 0L) ;
                  break ;
                }
	    ...
	    case 0x0f:		/* RSCS reg */
              ...
              if (BITS(4, 7) == 0x9)
                { /* MULL */
                  /* 32x32=64 */
                  ARMul_Icycles(state,
                      MultiplyAdd64(state, instr, LSIGNED, LSCC), 0L) ;
                  break ;
                }
...
{
   /* The ARM documentation implies (but does not state) that
    * the bottom bit of the PC is never set */
#ifdef MODE32
...
static unsigned
LoadHalfWord(ARMul_State *state, ARMword instr, ARMword address, int signextend)
{
  ARMword dest ;
